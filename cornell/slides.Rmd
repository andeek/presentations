...
**Challenge:** Develop implementations which are both *statistically rigorous* and *computationally scalable* by exploiting conditional independence, or Markov structures, in data models. 

1. Statistical quantification of graph models used in deep machine learning and image classification 
2. New, fast methods for simulating spatial, network, and other data with complex dependencies
