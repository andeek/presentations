...
<ol style="color: white">
  <li>Fork the repo from <a href="https://github.com/andeek/git-ladies" target=_blank style="color:black">https://github.com/andeek/git-ladies</a></li>
  <li>Edit the repo in some way.
  <ul>
  <li>Ideas: Edit the readme, add a new file, go nuts!</li>
  </ul></li>
