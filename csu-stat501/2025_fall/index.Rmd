...
---
background-image: url("images/tower.jpg.avif")
...
- Social science (Civilian casualty data in civil conflicts, global political events, genealogical reconstruction)

- Official statistics (Census, logitudinal surveys, voter data)

- Public health and biomedical research (Electronic health records)
  
- Ecology (Capture/Recapture studies, tree demography)
  
---
# Example: Tree Demography


.pull-left[
- Forest structural data collected via aerial laser scanning (Lidar) in 2015 and 2019 

- Airplane-based sensor records discrete peaks of reflected energy at near-infrared wavelengths 

- Lidar-derived point clouds segmented and summarized to yield estimates of per-tree structural characteristics
]

.pull-right[
![](images/polygon_image_2015.png)
]

---
# Goals and Challenges

**Goal:** Model the population growth curves of spruce-fir trees and better understand relationship with environmental factors.

**Challenges:**

- Segmentation and canopy surface model generation steps generate imperfect representations of individual tree locations and crown geometries. 

- Errors in sensor geo-positioning and ranging measurements can lead to systematic spatial shifts in datasets collected at different times. 

- Moreover, the location and trajectory of individual laser pulses differs between scans, leading to small amounts of variability in estimated maximum heights and crown locations.

We don't know how much each tree has grown without being able to **link** them across time!
...
1. Can we use alternative fitting methods (like variational) to scale this?
